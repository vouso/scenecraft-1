...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      name: 'runcomfy',
      title: 'RunComfy',
      description: `Custom <a href="https://runcomfy.com" class="text-primary" target="_blank">RunComfy</a> settings`,
      tab: 'ai',
    },
    {
      name: 'adsense',
...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    {
      name: 'runcomfy_api_key',
      title: 'RunComfy API Key',
      type: 'password',
      placeholder: 'xxx',
      group: 'runcomfy',
      tip: 'RunComfy API Key is used to access the RunComfy API',
      tab: 'ai',
    },
    {
      name: 'runcomfy_custom_storage',
      title: 'RunComfy Custom Storage',
      type: 'switch',
      value: 'false',
      group: 'runcomfy',
      tab: 'ai',
      tip: 'Use custom storage to save files generated by RunComfy',
    },
    {
      name: 'adsense_code',
      title: 'Adsense Code',
